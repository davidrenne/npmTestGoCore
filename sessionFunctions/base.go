...
import (
	...
	"github.com/davidrenne/npmTestGoCore/scheduleEngine"
	"github.com/davidrenne/npmTestGoCore/settings"
	"github.com/davidrenne/npmTestGoCore/viewModel/socketViews"
...
func WriteLog(uniqueId string, message string) (err error) {
	...
	log := "src/github.com/davidrenne/npmTestGoCore/log/plugins/" + uniqueId + ".log"
	if uniqueId == "" {
		log = "src/github.com/davidrenne/npmTestGoCore/log/app.log"
	}
